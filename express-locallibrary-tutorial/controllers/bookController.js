...
exports.book_delete_get = async (req, res, next) => {
  ...
  const [book, allBookInstancesByInstance] = await Promise.all([
    Book.findById(req.params.id).exec(),
    BookInstance.find({ book: req.params.id }, "id").exec(),
  ]);
  ...
  res.render("book_delete", {
    title: "Delete Book",
    book,
    book_bookinstances: allBookInstancesByInstance,
  });
};
...
exports.book_delete_post = async (req, res, next) => {
  ...
  if (allBookInstancesByInstance.length > 0) {
